  ...
  render() {
    ...
    return (
      <div className="Search">
        ...
        />
        <SearchResultHeader handleClickHelper={this.handleClickHelper} />
        <hr className="my-2" />
          ...
          <Row>
            <Col xs= "10">
              ...
              <Table responsive>
                ...
                <tbody>
                  <GenerateSearchResult data={this.state.data} modal={this.state.modal} toggle={this.toggle} />
                </tbody>
              </Table>
            </Col>
            <GenerateQueringTag search={this.state.search} handleClick={this.handleClick} handleReset={this.handleRest} />
          </Row>
        </Container>
      </div>
    )
